...
export const usePagedBookList = (initialPageSize, url = "http://localhost:3080/app/books") => {
...
export const usePagedSearchBookList = (initialPageSize, query, url = "http://localhost:3080/app/books") => {
    const [pageSize, setPageSize] = useState(initialPageSize);
    const [list, setList] = useState([]);
    const [location, setLocation] = useState(1);
    const [length, setLength] = useState(0);
...
export const deleteBook = async (id, login, url = "http://localhost:3080/app/book") => {
...
export const updateBook = async (book, login, url = "http://localhost:3080/app/books") => {
...
export const addBook = async (book, login, url = "http://localhost:3080/app/book") => {
